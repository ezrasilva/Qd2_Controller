# networks-it-uc3m/quditto/Quditto-main/qd2_controller/src/qd2_controller/controller.py
            ...
            if node["node_name"] == origin:
                for neighbour in node["neighbour_nodes"]:
                    if neighbour.get("name") == n and "link_length" in neighbour:
                        ...
                        # NOVO BLOCO INICIA
                        # Adiciona a lógica para ler os parâmetros de decoy states do YAML.
                        if "decoy_state_parameters" in neighbour:
                            decoy_params = neighbour["decoy_state_parameters"]
                            # Adiciona os parâmetros de decoy ao dicionário que será salvo.
                            filtered_params.update(decoy_params)
                        # NOVO BLOCO TERMINA
